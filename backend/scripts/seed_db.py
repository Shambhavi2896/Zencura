...
from backend.models import User, Department, Doctor, Patient, Appointment, Treatment, Payment
...
def seed_data():
    with app.app_context():
        ...
        departments_data = [
            {
                "name": "Cardiology",
                "desc": "Diagnosis and treatment of heart and blood vessel conditions.",
            },
            {
                "name": "Neurology",
                "desc": "Treatment of disorders of the nervous system.",
            },
            {
                "name": "Orthopedics",
                "desc": "Care for musculoskeletal injuries and conditions.",
            },
            {
                "name": "Pediatrics",
            ...
            },
            {
                ...
                "desc": "Surgical procedures for a wide range of conditions.",
            },
            {
                "name": "Dermatology",
                "desc": "Treatment of skin, hair, and nail conditions.",
            },
            {"name": "ENT", "desc": "Ear, nose, and throat specialist care."},
            {
                "name": "Ophthalmology",
                "desc": "Eye care and vision-related treatments.",
            },
        ]
        ...
        for i in range(40):
            ...
            if status == "Completed":
                ...
                payment = Payment(
                    ...
                    amount=random.choice([500.00, 750.00, 1000.00, 1500.00, 2000.00]),
        ...
        print(f"  - ~32 Payment records for completed treatments")
