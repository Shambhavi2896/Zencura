...
class Treatment(db.Model):
    ...
    appointment_id = db.Column(
        db.Integer, db.ForeignKey("appointment.id"), nullable=False, unique=True
    )
    ...
    payment = db.relationship(
        "Payment", backref="treatment", uselist=False, cascade="all, delete-orphan"
    )

class Payment(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    treatment_id = db.Column(
        db.Integer, db.ForeignKey("treatment.id"), nullable=False, unique=True
    )
