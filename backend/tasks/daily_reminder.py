...
@celery_app.task(name='backend.tasks.daily_reminder.send_daily_reminders', bind=True, max_retries=3)
        ...
        with app.app_context():
            ...
            for apt in appointments:
                try:
                    ...
                    user = User.query.filter_by(id=patient.user_id).first() if patient else None
                    ...
                    msg = Message(
                        ...
                        <div style="max-width: 600px; margin: auto; background: white; padding: 30px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                            <h2 style="color: #14b8a6; margin-top: 0;">Appointment Reminder</h2>
